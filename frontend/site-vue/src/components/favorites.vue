...
// NOTE: L'ID utilisateur doit provenir de l'authentification (non implémentée ici).
// Nous allons utiliser un ID fictif pour les tests.
const MOCK_USER_ID = "60c72b1f9b3b8e001c9a0d84" // ID d'exemple pour le test
...
async function fetchFavorites() {
    ...
    error.value = null
    try {
        // Appelle la fonction API pour récupérer les favoris de l'utilisateur
        favorites.value = await listFavorites(MOCK_USER_ID)
    } catch (err) {
...
<template>
    <Navbar logo-src="/src/assets/Greenstyle-logo.png" />
